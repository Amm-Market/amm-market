    ...
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <section id="withdrawal-process" className="mb-12">
          <h2 className="mb-4">Withdrawal Process</h2>
          <div className="space-y-5 text-sm text-type-secondary">
            <div>
              <p>1. Repay debt if needed</p>
              <p className="mt-1">
            ...
            <div>
              <p>3. Health check and release</p>
              <p className="mt-1">
        ...
        <section id="partial-withdrawal" className="mb-12">
          <h2 className="mb-4">Partial Withdrawal</h2>
          <p>
        ...
        <section id="after-withdrawal" className="mb-12">
          <h2 className="mb-4">After Withdrawal</h2>
