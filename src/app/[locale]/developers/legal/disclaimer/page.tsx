  ...
  return withDocsI18n("legal/disclaimer", (
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      ...
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <p className="border-l-4 border-amber-400 pl-3 mb-8">
        ...
        <section id="general-disclaimer" className="mb-12">
          <h2 className="mb-4">General Disclaimer</h2>
          <p className="mb-4">
        ...
        <section id="no-financial-advice" className="mb-12">
          <h2 className="mb-4">No Financial Advice</h2>
          <p className="mb-4">
        ...
        <section id="risks" className="mb-12">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-red-400 pl-3">
              <h3 className="text-foreground mb-2">Experimental Technology</h3>
              <p>
            ...
            <div className="border-l-4 border-amber-400 pl-3">
              <h3 className="text-foreground mb-2">Operational Challenges</h3>
              <p>
            ...
            <div className="border-l-4 border-amber-400 pl-3">
              <h3 className="text-foreground mb-2">Regulatory Uncertainty</h3>
              <p>
            ...
            <div>
              <h3 className="text-foreground mb-2">LP-Specific Risks</h3>
              <ul className="text-type-secondary text-sm space-y-1">
        ...
        <section id="no-warranties" className="mb-12">
          <h2 className="mb-4">No Warranties</h2>
          <p className="mb-4">
        ...
        <section id="related-policies" className="mb-12">
          ...
          <div className="space-y-3">
            ...
            <Link href="/developers/legal" className="block p-4 border border-border rounded-lg hover:border-gray-300 hover:bg-muted/40/50 transition-colors">
              <h3 className="text-foreground mb-1">Restricted Territories</h3>
              <p>
        ...
        <div className="p-4 bg-gray-100 rounded-lg border border-border mt-8">
          <p>
