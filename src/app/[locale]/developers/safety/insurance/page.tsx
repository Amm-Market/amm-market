    ...
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <section id="funding-approach" className="mb-12">
          <h2 className="mb-4">Funding Approach</h2>
          <p className="mb-4">
        ...
        <section id="activation-path" className="mb-12">
          <h2 className="mb-4">Activation Path</h2>
        ...
        <section id="coverage-boundary" className="mb-12">
          <h2 className="mb-4">Coverage Boundary</h2>
          <p className="mb-4">
          ...
          <div className="rounded-lg border border-border bg-muted/40 p-4 text-sm text-type-secondary">
