    ...
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <section id="how-it-works" className="mb-12">
          ...
          <ol className="space-y-4">
            <li className="flex gap-4">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-cyan-50 text-sm font-semibold text-type-accent">
                01
              </div>
        ...
        <section id="borrowable-value" className="mb-12">
          <h2 className="mb-4">Borrowable Value</h2>
          <p className="mb-4">
          ...
          <div className="rounded-lg border border-cyan-200 bg-cyan-50/60 p-4 text-sm text-type-secondary">
