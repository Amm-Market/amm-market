    ...
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <section id="user-experience" className="mb-12">
          <h2 className="mb-4">Borrow Flow</h2>
          <p className="mb-4">
        ...
        <section id="example-flow" className="mb-12">
          <h2 className="mb-4">Example Flow</h2>
          <div className="space-y-6">
            <div className="border-b border-gray-100 pb-4">
              <h3 className="mb-2">Step 1: Deposit LP collateral</h3>
              <p>
            ...
            <div className="border-b border-gray-100 pb-4">
              <h3 className="mb-2">Step 2: Capacity is calculated</h3>
              <p>
            ...
            <div className="border-b border-gray-100 pb-4">
              <h3 className="mb-2">Step 3: Borrow assets</h3>
              <p>
            ...
            <div>
              <h3 className="mb-2">Step 4: Add more collateral</h3>
              <p>
        ...
        <section id="three-tier-architecture" className="mb-12">
          <h2 className="mb-4">Three-Tier Architecture</h2>
          <div className="space-y-6">
            <div>
              <h3 className="mb-2">Borrowers</h3>
              <p>
            ...
            <div>
              <h3 className="mb-2">Borrow Spoke (Avana)</h3>
              <p>
            ...
            <div>
              <h3 className="mb-2">Aave v4 Hub</h3>
              <p>
        ...
        <section id="data-flow" className="mb-12">
          <h2 className="mb-4">Data Flow</h2>
          <ol className="mb-6 list-decimal list-inside space-y-4">
            <li className="text-sm text-type-secondary">
              <strong className="text-foreground">Collateral enters the spoke</strong> — the LP
              position is recorded and tracked for valuation and health.
            </li>
            <li className="text-sm text-type-secondary">
              <strong className="text-foreground">Borrow draws Hub liquidity</strong> — once capacity
              checks pass, the spoke requests assets from the Hub.
            </li>
            <li className="text-sm text-type-secondary">
              <strong className="text-foreground">Debt accrues as debt shares</strong> — interest
              compounds through the configured rate model while the spoke keeps account state in sync.
            </li>
            <li className="text-sm text-type-secondary">
              <strong className="text-foreground">Liquidation if required</strong> — unhealthy
              accounts move through the liquidation path to restore solvency.
            </li>
          </ol>

          <div>
            <h3 className="mb-2">Hub interaction</h3>
            <ul className="space-y-1 text-sm text-type-secondary">
              ...
              <li>• <strong>Health check:</strong> Hub reads spoke collateral data via <code className="bg-gray-100 px-1 rounded text-foreground">getCollateralData</code></li>
              <li>• <strong>Liquidation:</strong> Hub can call <code className="bg-gray-100 px-1 rounded text-foreground">handleLiquidation</code> when risk thresholds are breached</li>
            </ul>
          </div>
        </section>

        <section id="spoke-responsibilities" className="mb-12">
          <h2 className="mb-4">Spoke Responsibilities</h2>
          <div className="mb-6 overflow-x-auto">
            <table className="w-full overflow-hidden rounded-lg border border-border text-sm">
              <thead className="bg-muted/40">
                <tr>
                  <th className="px-4 py-2 text-left text-foreground">Component</th>
                  <th className="px-4 py-2 text-left text-foreground">Responsibility</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-4 py-2 font-medium text-foreground">Borrow Spoke</td>
                  <td className="px-4 py-2 text-type-secondary">
                ...
                <tr>
                  <td className="px-4 py-2 font-medium text-foreground">LiquidationAdapter</td>
                  <td className="px-4 py-2 text-type-secondary">
        ...
        <section id="hub-role" className="mb-12">
          <h2 className="mb-4">Aave v4 Hub Role</h2>
          <p className="mb-4">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="mb-2">Capital supply</h3>
              <p>
            ...
            <div>
              <h3 className="mb-2">Credit lines</h3>
              <p>
            ...
            <div>
              <h3 className="mb-2">Independent health factors</h3>
              <p>
