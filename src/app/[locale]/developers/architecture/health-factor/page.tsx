    ...
    <div className="flex min-w-0 flex-col gap-8 xl:flex-row xl:items-start xl:gap-12">
      <div data-developer-doc-export-root className="min-w-0 w-full max-w-3xl flex-1">
        ...
        <section id="calculation" className="mb-12">
          <h2 className="mb-4">Calculation</h2>
          <p className="mb-4">
        ...
        <section id="health-bands" className="mb-12">
          <h2 className="mb-4">Monitoring Bands</h2>
          <div className="space-y-4 text-sm text-type-secondary">
            <p>
              <strong className="text-foreground">Healthy:</strong> collateral stays comfortably above
        ...
        <section id="response-path" className="mb-12">
          <h2 className="mb-4">Response Path</h2>
          <div className="space-y-4 text-sm text-type-secondary">
            <p>
        ...
        <section id="user-actions" className="mb-12">
          <h2 className="mb-4">User Actions</h2>
