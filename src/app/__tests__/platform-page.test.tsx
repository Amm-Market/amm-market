...
describe("platform page", () => {
  ...
  it("restores the platform content while using the current app shell", () => {
    ...
    expect(screen.getByText(/Real-time health monitoring, automated alerts, and auto-repay tools help you stay ahead of risk\./i)).toBeInTheDocument()
    ...
    expect(safetyHeading.compareDocumentPosition(platformToolsHeading) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy()
