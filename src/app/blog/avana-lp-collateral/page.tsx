...
const tableOfContents = [
  ...
  { id: "aave-v4-foundation", title: "Aave v4 as the foundation" },
  { id: "benefits", title: "Benefits for Liquidity Providers" },
  { id: "conclusion", title: "Conclusion" },
]

export default function AvanaLpCollateralPage() {
  return (
    <BlogPostLayout
      title="Avana Empowering Liquidity Providers With Collateral"
      date="January 18, 2026"
      description="How Avana allows LP tokens to be used as collateral, unlocking capital efficiency while liquidity keeps earning fees."
    ...
    >
      <section id="introduction" className="mb-12 scroll-mt-24">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Avana changes this dynamic. It allows LP tokens themselves to be used as collateral in lending protocols. 
      ...
      <section id="aave-v4-foundation" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Aave v4 as the foundation</h2>
        
        <p className="text-gray-700 leading-relaxed mb-6">
          Avana builds on Aave v4&apos;s lending architecture to formalize LP-backed borrowing as a first-class workflow. 
          With the Hub-and-Spoke model, selected Uniswap and Balancer LP positions can be valued, risk-scored, and 
          borrowed against without fragmenting the shared liquidity that powers the broader system.
        </p>
      ...
      <section id="conclusion" className="scroll-mt-24">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          ...
          DeFi. Avana bridges the gap between trading and lending by turning LP positions into fully composable 
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-lg text-white not-prose">
          ...
          <p>
            ...
            Avana transforms LP tokens from passive receipts into active collateral, unlocking their full potential 
