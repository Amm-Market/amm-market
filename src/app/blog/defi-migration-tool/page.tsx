...
const tableOfContents = [
  ...
  { id: "landscape", title: "The Current DeFi Landscape" },
  { id: "router", title: "Dex Mini Router Solution" },
  { id: "capabilities", title: "Key Capabilities" },
  { id: "how-it-works", title: "How It Works" },
  { id: "developers", title: "Empowering Developers" },
  { id: "future", title: "The Future of Liquidity Management" },
...
export default function BlogPost() {
  return (
    <BlogPostLayout
      title="Dex Mini Router: Simplifying the Labyrinth of Liquidity Migration"
      date="March 4, 2025"
      description="A comprehensive solution for seamless migration of assets across DeFi protocols."
    ...
    >
      ...
      <div id="features" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 not-prose scroll-mt-24">
        <div className="bg-indigo-50 border border-indigo-100 p-6 rounded-lg">
          <h3 className="text-lg font-semibold text-indigo-800 mb-3">Atomic Transactions</h3>
        ...
        <div className="bg-indigo-50 border border-indigo-100 p-6 rounded-lg">
          <h3 className="text-lg font-semibold text-indigo-800 mb-3">Automated Management</h3>
          <p className="text-gray-700">
            Automatically harvest rewards, calculate fees, and reconfigure positions with equivalent parameters.
          </p>
        </div>
        <div className="bg-indigo-50 border border-indigo-100 p-6 rounded-lg">
          <h3 className="text-lg font-semibold text-indigo-800 mb-3">Enhanced Security</h3>
          <p className="text-gray-700">
      ...
      <section id="landscape" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">The Current DeFi Landscape</h2>
      ...
      <section id="router" className="mb-12 scroll-mt-24">
      ...
      <section id="capabilities" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">
      ...
      <section id="developers" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">
      ...
      <section id="conclusion" className="scroll-mt-24">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Conclusion: Bridging the Gap in DeFi</h2>
