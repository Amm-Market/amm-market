...
const tableOfContents = [
  { id: "holistic", title: "The Holistic Nature of DeFi UX" },
  { id: "mainstream", title: "The Importance of Mainstream Adoption" },
  { id: "security", title: "Enhancing Security Through Safeguards" },
  { id: "dex-mini", title: "Dex Mini UX/UI: A Comprehensive Solution" },
  { id: "dimensions", title: "Addressing Critical UX Dimensions" },
  { id: "freedom", title: "Freedom Through Seamless Integration" },
  { id: "protection", title: "Security Through Intelligent Protection" },
  { id: "future", title: "Embracing the Future of DeFi" },
]

export default function BlogPost() {
  return (
    <BlogPostLayout
      title="How Dex Mini Solves DeFi UX Challenges"
      date="February 28, 2025"
      description="A comprehensive approach to addressing the user experience barriers in decentralized finance."
    ...
    >
      {/* Visual summary */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 not-prose">
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
          <h3 className="font-semibold text-lg mb-2 text-indigo-800">Holistic Design</h3>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
          <h3 className="font-semibold text-lg mb-2 text-indigo-800">Enhanced Security</h3>
      ...
      <section id="holistic" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">The Holistic Nature of DeFi UX</h2>
      ...
      <section id="mainstream" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">The Importance of Mainstream Adoption</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="security" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Enhancing Security Through Transparent Safeguards</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="dex-mini" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Dex Mini UX/UI: A Comprehensive Solution</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="dimensions" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Addressing the Three Critical UX Dimensions</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="freedom" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Freedom Through Seamless Integration</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="protection" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Security Through Intelligent Protection</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
      ...
      <section id="future" className="scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Embracing the Future of DeFi</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
