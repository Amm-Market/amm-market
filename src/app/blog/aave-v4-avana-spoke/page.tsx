...
export default function AaveV4AvanaSpokePage() {
  return (
    <BlogPostLayout
      title="Borrowing Against Uniswap LP Tokens via Aave v4's Avana Spoke"
    ...
    >
      <section id="hub-spoke-architecture" className="mb-12 scroll-mt-24">
        ...
        <p className="text-gray-700 leading-relaxed">
          The Avana Spoke is one such specialized module. It is purpose built to support loans collateralized by 
          automated market maker liquidity positions, particularly concentrated liquidity positions such as Uniswap V3 
          LP NFTs. By plugging into the shared Liquidity Hub, the Avana Spoke can offer deep and efficient 
      ...
      <section id="lp-tokens-collateral" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">LP Tokens as Collateral in the Avana</h2>
        ...
        <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-lg mb-6 not-prose">
          ...
          <p className="text-gray-700">
            The Avana Spoke addresses this by relying on oracle driven pricing combined with on chain liquidity 
        ...
        <p className="text-gray-700 leading-relaxed">
          ...
          movements, the Avana Spoke can dynamically adjust loan to value limits to reflect changes in risk. 
      ...
      <section id="borrowing-workflow" className="mb-12 scroll-mt-24">
        <h2 className="text-2xl font-bold mb-6 text-gray-900">Borrowing Workflow in the Avana Spoke</h2>
        ...
        <div className="space-y-4 not-prose mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="pt-1">
              ...
              <p className="text-gray-700">
                The user deposits their liquidity position NFT into the Avana Spoke. This action designates the 
      ...
      <section id="positions-remain-active" className="mb-12 scroll-mt-24">
        ...
        <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded-r-lg mb-6 not-prose">
          ...
          <p className="text-gray-700">
            The Avana Spoke exposes a fee collection mechanism that allows users to claim accumulated trading 
      ...
      <section id="repayment-health" className="mb-12 scroll-mt-24">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Throughout the loan&apos;s lifetime, the Avana Spoke continuously monitors the position&apos;s health factor. 
      ...
      <section id="summary" className="scroll-mt-24">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          The Avana Spoke in Aave v4 is purpose built to enable borrowing against automated market maker 
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-lg text-white not-prose">
          ...
          <p>
            ...
            system that abstracts complexity without sacrificing transparency. In doing so, the Avana Spoke 
