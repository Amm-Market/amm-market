    ...
    <div className="flex min-h-screen flex-col bg-white">
      <main className="flex-1 py-12">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
          <div className="mb-8 py-12 text-center lg:mb-12 lg:py-20">
            <h1 className="type-page-title mb-8 italic text-gray-900">How can we help?</h1>
            ...
            <div className="mx-auto max-w-md">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search"
                  className="w-full rounded-full border border-gray-300 bg-white py-3 pl-12 pr-10 text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200"
                  value={searchTerm}
          ...
          <div>
            {searchTerm ? (
              <>
                <h2 className="mb-6 text-2xl font-medium">Search Results</h2>
              ...
              <>
                <h2 className="mb-6 text-2xl font-medium">{activeCategory}</h2>
                <Accordion type="single" collapsible className="w-full">
