  ...
  return (
    <div className="pb-16 md:pb-32 max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
      <div className="flex flex-col gap-3">
        <p className="text-emerald-500 text-sm">Unlock the full potential of Uniswap Hooks</p>
        <div className="flex flex-col gap-4">
          <h2 className="text-3xl font-bold">Broaden your exposure</h2>
        ...
        <ul className="flex flex-col gap-2 mt-1 mb-4">
          <li className="flex items-center gap-2">
            ...
            <span className="text-gray-900 text-sm">Multi-Network Support</span>
          </li>
          <li className="flex items-center gap-2">
            <div className="flex items-center justify-center w-4 h-4 text-emerald-500">
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-gray-900 text-sm">Industry-Leading Returns</span>
          </li>
          <li className="flex items-center gap-2">
            <div className="flex items-center justify-center w-4 h-4 text-emerald-500">
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-gray-900 text-sm">Exclusive Rewards</span>
          </li>
          <li className="flex items-center gap-2">
            <div className="flex items-center justify-center w-4 h-4 text-emerald-500">
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-gray-900 text-sm">Simplified Portfolio Management</span>
          </li>
        </ul>
      </div>
