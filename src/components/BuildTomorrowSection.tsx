      ...
      <div className="site-content-shell">
        ...
        <div className="mt-24 grid grid-cols-1 gap-12 md:mt-32 md:grid-cols-[minmax(0,29rem)_minmax(0,1fr)] md:gap-10 lg:gap-12 xl:grid-cols-[minmax(0,30rem)_minmax(0,1fr)] 2xl:mt-28">
          <div className="space-y-4">
            <SectionEyebrow tone="violet">LP-backed lending</SectionEyebrow>
            <SectionTitle>
              <span className="block lg:hidden">Designed for modern DEXs</span>
              <span className="hidden lg:block lg:whitespace-nowrap">Designed for</span>
              <span className="hidden lg:block lg:whitespace-nowrap">modern DEXs</span>
            </SectionTitle>
          </div>
