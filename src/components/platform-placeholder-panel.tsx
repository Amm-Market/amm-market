import styles from "./platform-placeholder-panel.module.css"
  ...
  if (v === 0) {
    ...
    return (
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 overflow-hidden">
        ...
        <div className={`${styles.breathe} flex flex-col items-center gap-1`}>
        ...
        <div className="w-full overflow-hidden">
          <div className={`${styles.scroll} flex w-max whitespace-nowrap`}>
        ...
        {metrics.map((m, i) => (
          <div key={i} className="w-full max-w-[13rem]">
            ...
            <div className="h-[5px] w-full overflow-hidden rounded-full bg-white/15">
              <div
                className={`${styles.barGrow} h-full origin-left rounded-full bg-white/50`}
    ...
    return (
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative h-[140px] w-[140px]">
          ...
          {/* Center glow */}
          <div className={`${styles.pulse} absolute inset-[46px] rounded-full bg-white/20`} />
  ...
  if (v === 3) {
    ...
    return (
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 overflow-hidden">
        <div className={`${styles.breathe} flex h-16 w-16 items-center justify-center rounded-[22px] border border-white/35 bg-white/20 backdrop-blur-sm`}>
  ...
  if (v === 4) {
    ...
    return (
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <svg className={`${styles.breathe} h-[100px] w-[100px] -rotate-90`} viewBox="0 0 100 100">
        ...
        <div className="mt-3 flex items-center gap-1.5">
          <div className={`${styles.pulse} h-2 w-2 rounded-full bg-white/60`} />
        ...
        <div className="mt-4 flex gap-2.5">
          {[{ w: "2.8rem", d: "0s" }, { w: "2rem", d: "2s" }, { w: "1.4rem", d: "4s" }].map((bar, i) => (
            <div key={i} className={`${styles.barGrow} h-[4px] rounded-full bg-white/30`} style={{ width: bar.w, animationDelay: bar.d }} />
          ))}
        </div>
      </div>
    )
        ...
        {[
          ...
          <div key={i} className="w-full max-w-[14rem] rounded-xl border border-white/25 bg-white/15 px-4 py-2.5 backdrop-blur-sm">
            ...
            <div className="h-[4px] w-full overflow-hidden rounded-full bg-white/15">
              <div
                className={`${styles.warnBar} h-full origin-left rounded-full bg-white/55`}
                style={{ animationDelay: item.delay }}
              />
            </div>
          </div>
        ))}
        <div className={`${styles.pulse} mt-1 flex items-center gap-1.5 rounded-full border border-white/25 bg-white/15 px-3 py-1 backdrop-blur-sm`}>
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 overflow-hidden px-6">
      ...
      <div className="w-full max-w-[16rem] overflow-hidden">
        <div className={styles.scroll} style={{ width: "200%" }}>
      ...
      {/* Fast pulsing label */}
      <div className={`${styles.pulseFast} flex items-center gap-1.5 rounded-full border border-white/25 bg-white/15 px-3 py-1 backdrop-blur-sm`}>
        <div className="h-1.5 w-1.5 rounded-full bg-white/70" />
